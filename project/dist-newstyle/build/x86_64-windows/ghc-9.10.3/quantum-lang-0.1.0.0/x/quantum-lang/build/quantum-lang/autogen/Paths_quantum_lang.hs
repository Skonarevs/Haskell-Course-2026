...
getDynLibDir  = catchIO (getEnv "quantum_lang_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "quantum_lang_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "quantum_lang_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "quantum_lang_sysconfdir") (\_ -> return sysconfdir)
